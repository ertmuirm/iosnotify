    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 0) {
                ...
                infoRow("")
                infoRow("1. Scan and tap Bond — iOS will show a Bluetooth")
                infoRow("   Pairing Request dialog. Tap Pair.")
                infoRow("")
                infoRow("2. Open iOS Settings → Bluetooth")
                infoRow("3. Find your device and tap the  ⓘ  icon next to it")
                infoRow("4. Enable \"Share System Notifications\"")
                infoRow("")
                infoRow("If the pairing dialog does not appear, remove the device")
                infoRow("here and in iOS Settings → Bluetooth, then bond again.")
            }
        }
